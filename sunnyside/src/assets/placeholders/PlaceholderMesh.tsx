 ...
 *    рисуем явный magenta-маркер (тот же приём, что и в scene/assets/Prop.tsx).
 ...
 *
 * Это НЕЗАВИСИМЫЙ, более полный компонент, чем `src/scene/assets/Prop.tsx`
 * (тот — тонкий рантайм-рендер для сцен фермы/города/ярмарки/смены с собственным мини-реестром;
 * этот — универсальный рендер ЛЮБОГО ассета из полного мастер-каталога Фазы D, включая
 * персонажей/животных/декор/town-projects/env-пропсы, которых пока нет в scene/assets/registry.ts).
 * Сцен-агенты могут переключить `Prop` на этот компонент, когда каталоги сойдутся.
 */
